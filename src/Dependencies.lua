...
gTextures = {
    ...
    ["bigfin-back"] = love.graphics.newImage("graphics/pokemon/bigfin-back.png"),
    ["bigfin-front"] = love.graphics.newImage("graphics/pokemon/bigfin-front.png"),
    ["sharpfin-back"] = love.graphics.newImage("graphics/pokemon/sharpfin-back.png"),
    ["sharpfin-front"] = love.graphics.newImage("graphics/pokemon/sharpfin-front.png")
}
